...
def downloadsocks(choice):
	if choice == "4":
		...
		try:
			...
			pass
		try:
			r = requests.get("https://raw.githubusercontent.com/SPHINX110/storm/main/sockss4.txt",timeout=5)
			f.write(r.content)
		except:
			pass	
		try:
	...
	if choice == "5":
		...
		try:
			...
			pass
		try:
			r = requests.get("https://raw.githubusercontent.com/SPHINX110/storm/main/proxies.txt",timeout=5)
			f.write(r.content)
		except:
			pass
		try:
			r = requests.get("https://raw.githubusercontent.com/SPHINX110/storm/main/sockss5.txt",timeout=5)
			f.write(r.content)
		except:
			pass	
		try:
